      ...
      <div class="navbar-end">
        ...
        <nav-bar-menu class="has-divider has-user-avatar">
          ...
          <div slot="dropdown" class="navbar-dropdown">
            ...
            <hr class="navbar-divider">
            <a class="navbar-item" href="/api/security/logout">
        ...
        <a class="navbar-item is-desktop-icon-only" href="/api/security/logout" title="Log out" @click="logout">
          <b-icon icon="logout" custom-size="default"/>
          <span>Log out</span>
        </a>
      </div>
...
import NavBarMenu from 'admin/components/NavBarMenu'
