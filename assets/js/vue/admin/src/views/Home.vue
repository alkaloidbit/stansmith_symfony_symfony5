...
<script>
import * as chartConfig from 'admin/components/Charts/chart.config'
...
import CardWidget from 'admin/components/CardWidget'
import CardComponent from 'admin/components/CardComponent'
import LineChart from 'admin/components/Charts/LineChart'
import ClientsTableSample from 'admin/components/ClientsTableSample'
